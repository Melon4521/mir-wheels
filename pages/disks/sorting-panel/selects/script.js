! function (e, t) {
    ...
    return function (e) {
        ...
        function l(e, t, n) {
            void 0 === n && (n = null);
            var a, d = "undefined" != typeof window,
                c = [];
            if (a = n instanceof o.default ? n : new o.default, "boolean" == typeof n && !0 === n) a.deep = !0;
            else if (n && a !== n && "object" == typeof n && (l(a, n), [i.default.PUSH, i.default.REPLACE].indexOf(a.arrayStrategy) < 0)) throw RangeError(s.INVALID_ARRAY_STRATEGY(a.arrayStrategy));
            ...
            for (var p = 0, h = c; p < h.length; p++) {
                ...
                if (("function" != typeof b.get || b.set || a.includeReadOnly) && (b.enumerable || a.includeNonEmurable))
                    if (!a.deep || "object" != typeof t[v] || d && t[v] instanceof window.Node || d && t[v] === window.document.body || d && t[v] === window.document.documentElement || null === t[v] || Array.isArray(t[v]) && a.useReferenceIfArray || !e[v] && a.useReferenceIfTargetUnset) try {
                        e[v] = t[v]
                    } catch (t) {
        ...
        t.default = function (e, t) {
            ...
            if (!l.isUseNativeMode && !l.isDisabled) switch (n) {
                ...
                case r.ENTER:
                    e.stopPropagation(), e.preventDefault(), i.default(s, t), l.isOpen ? d.selectOption(l.focusedIndex, f.behavior.closeOnSelect) : o.default(d, f, c);
                    break;
                case r.ESC:
                    d.close()
            }
        ...
        t.default = function (e, t) {
            ...
            do {
                d += f, f = 1, d >= a.totalOptions && (d = l.behavior.loop ? 0 : a.totalOptions - 1), s.focusOption(d, !0), c++
        ...
        t.default = function (e, t) {
            var n = e.metaKey,
                ...
                c = 0,
                f = 1;
            e.preventDefault(), i.default(r, t), n && (f = Math.round(Math.max(a.totalOptions / 2, u.behavior.maxVisibleItems)));
            do {
        ...
        t.default = function (e, t, n) {
            var i = e.keyCode,
                r = t.actions,
                a = t.timers;
            void 0 === n && (n = 1200), t.state.isUseNativeMode || [o.UP, o.DOWN].includes(i) || (window.clearTimeout(a.searchTimeoutId), r.search(), a.searchTimeoutId = window.setTimeout((function () {
            ...
            s = function () {
                ...
                return e.prototype.render = function (t, n) {
                    var a = o.default(t, this.classNames),
                        u = i.default(a);
                    return this.dom = new r.default, this.dom.root = u, this.dom.option.length = this.dom.group.length = 0, e.queryDomRefs(this.dom), this.injectSelect(n), this.dom
        ...
        var o = n(2),
            i = n(53);
        t.default = function (e, t) {
            var n = o.default([t.body, [e.isAtTop, t.bodyAtTop],
        ...
        var o = n(2),
            i = n(54);
        t.default = function (e, t, n) {
            return '\n        <div class="' + o.default([n.group, [e.isDisabled, n.groupDisabled],
        ...
        t.default = function (e, t, n) {
            ...
            return '\n        <div\n            class="' + o.default([n.option, [i, n.optionSelected],
        ...
        var o = function () {
            ...
            return e.prototype.sumItemsHeight = function (e) {
                void 0 === e && (e = 1 / 0);
                for (var t = 0, n = 0, o = void 0;
                    (o = this.item[n]) && n !== e; n++) t += o.offsetHeight;
                return t
            }, e
        }();
        t.default = o
        ...
        t.default = function e(t, n) {
            ...
            if (t instanceof Text && n instanceof Text) t.textContent === n.textContent ? s.type = r.default.NONE : (s.type = r.default.INNER, s.newTextContent = n.textContent);
            ...
            else if (o.default(s, u(t, n)), s.attributeChanges.length > 0 ? s.type = r.default.FULL : s.type = r.default.INNER, (i = t.childNodes.length) > 0 && i === n.childNodes.length)
        ...
        t.default = function (e) {
            return {
                ...
                selectOption: function (t, n) {
                    ...
                    e.isClickSelecting = !1, t > -1 && (!o || o.isDisabled) || (e.selectedIndex = t, e.isInvalid && e.hasValue && this.validate(), e.isSearching ? this.scrollToView(e) : n && this.close())
                },
                ...
                return e.mapFromSelect = function (t, n) {
                    ...
                    for (var a = 0, s = void 0; s = t.children[a]; a++)
                        if (0 !== a || null === s.getAttribute("data-placeholder"))
                            if (s instanceof HTMLOptionElement) !1 === r && (o.groups.push(e.mapGroup()), r = !0), o.lastGroup.options.push(e.mapOption(s)), s.selected && (o.selectedIndex = o.totalOptions - 1);
                            else {
                                ...
                                for (var l = 0, d = void 0; d = s.children[l]; l++) o.lastGroup.options.push(e.mapOption(d, s)), d.selected && (o.selectedIndex = o.totalOptions - 1);
                                r = !1
                            }
